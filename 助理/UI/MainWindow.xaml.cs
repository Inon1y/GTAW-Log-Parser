...
#pragma warning restore 162
        ...
        private void CheckForUpdates(ref bool manual)
        {
            try
            {
                ...
                IReadOnlyList<Release> releases = _client.Repository.Release.GetAll("https://gitee.com/Ciscaux/GTAWCN-Log-Parser/releases", AppController.ProductHeader).Result;

                string newVersion = string.Empty;
                bool isNewVersionBeta = true;
...
#pragma warning restore 162
        ...
        private void InitializeTrayIcon()
        {
            _trayIcon = new System.Windows.Forms.NotifyIcon
            {
                ...
                Text= @"GTA:WOLRD聊天解析助手"
            };

            _trayIcon.MouseDoubleClick += TrayIcon_MouseDoubleClick;

            _trayIcon.ContextMenuStrip = new System.Windows.Forms.ContextMenuStrip();
            _trayIcon.ContextMenuStrip.Items.Add(@"打开", null, ResumeTrayStripMenuItem_Click);
            _trayIcon.ContextMenuStrip.Items.Add(@"退出", null, ExitTrayToolStripMenuItem_Click);
        }
